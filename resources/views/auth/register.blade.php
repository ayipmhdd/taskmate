...
<body class="h-full font-sans antialiased text-[#1b1b18]">
    <div class="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <h2 class="mt-6 text-center text-3xl font-black tracking-tight uppercase">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white px-6 py-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#19140015] sm:rounded-2xl sm:px-10">
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        @error('name') <p class="mt-1 text-xs text-red-500 italic font-medium">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('email') <p class="mt-1 text-xs text-red-500 italic font-medium">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700">Konfirmasi</label>
                            <div class="mt-1.5">
                    ...
                    @error('password') <p class="text-xs text-red-500 italic font-medium">{{ $message }}</p> @enderror
                    ...
                    <div class="pt-4 flex flex-col gap-4">
                        ...
                        <div class="relative py-2">
                            <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-[#19140010]"></div></div>
                            <div class="relative flex justify-center text-xs uppercase"><span class="bg-white px-3 text-gray-400 font-medium">Sudah punya akun?</span></div>
                        </div>
