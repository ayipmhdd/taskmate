    ...
    <div class="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white px-6 py-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#19140015] sm:rounded-2xl sm:px-10">
                ...
                @if(session('success'))
                <div class="mb-6 p-3 rounded-lg bg-green-50 border border-green-100 text-sm text-green-600 font-medium text-center">
                    {{ session('success') }}
                </div>
                @endif
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="pt-2 flex flex-col gap-4">
                        ...
                        <div class="relative py-2">
                            ...
                            <div class="relative flex justify-center text-xs uppercase"><span class="bg-white px-3 text-gray-400 font-medium">Belum punya akun?</span></div>
                        </div>
